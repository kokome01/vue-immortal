    ...
    <div class="login_box">
      <el-form :model="inputForm" status-icon :rules="rules" ref="ruleForm">
        ...
        <el-form-item prop="password">
          <el-input 
            class="login_input" prefix-icon="el-icon-lock" placeholder="请输入新密码" v-model="inputForm.password" show-password>
          </el-input>
        </el-form-item>
        ...
        <el-button style="width: 100%" class="login_button" type="primary">修改密码</el-button>
      </el-form>
    </div>
